    ...
    <div className={cn('rounded-xl border border-zinc-700/50 bg-zinc-900/60', className)}>
      ...
      <div className="space-y-4 p-4">
        ...
        <div>
          ...
          {readOnly && (
            <p className="mb-2 text-[11px] text-zinc-500">{readOnlyHint}</p>
          )}
          ...
          {fds.length === 0 && (
            <div className="rounded-lg border border-dashed border-zinc-800/50 px-3 py-3 text-[11px] text-zinc-600">
